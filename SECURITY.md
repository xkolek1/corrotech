...
Since this is an internal proprietary application (CORROTECH CPQ), only the latest deployed version on the main branch is actively supported with security updates.
