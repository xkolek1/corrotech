...
def render_ai_assistant():
    ...
    * Import dat (Admin): Administrátoři mohou hromadně nahrávat z Excelu ceníky, adresáře a prodejní data.
    ...
    2. Představuj funkce aplikace sebevědomě, jako bys byl její přímou součástí.
    ...
    5. Pokud se dotaz zjevně netýká obchodu, barev, naší aplikace nebo cenotvorby, zdvořile debatu ukonči s tím, že jsi specializovaný CPQ asistent a na jiná témata nediskutuješ.
    """
